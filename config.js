...
module.exports = {
    VERSION: 'v3.0.0',
    CHANNEL: 'undefined',
    SESSION: process.env.SANA_CODE === undefined ? 'apikey' : process.env.SANA_CODE,
    ANTİLİNK: process.env.ANTİ_LİNK === undefined ? 'false' : process.env.ANTİ_LİNK,
    AFN: process.env.ALL_CAPTION === undefined ? '*ᴍᴀᴅᴇ ʙʏ sᴀɴᴀ ᴍᴡᴏʟ*' : process.env.ALL_CAPTION,
    ...
    ANTI_FILTER: process.env.REMOVE_FILTER === undefined ? 'ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝sᴀɴᴀ ᴍᴡᴏʟ࿐' : process.env.REMOVE_FILTER,
    ...
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'ᴀғx-ᴀʙᴜ;ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝sᴀɴᴀ ᴍᴡᴏʟ࿐;https://i.imgur.com/ucS4OCE.jpg' : process.env.AUDIO_DATA,
    BLOCKCHAT: process.env.BLOCK_CHAT === undefined ? false : process.env.BLOCK_CHAT,
    ADDMSG: process.env.ADD_MESSAGE === undefined ? 'default' : process.env.ADD_MESSAGE,
    MUTEMSG: process.env.MUTE_MESSAGE === undefined ? 'default' : process.env.MUTE_MESSAGE,
    PLK: process.env.OWNER_NAME === undefined ? 'ᴀғx-ᴀʙᴜ' : process.env.OWNER_NAME,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝sᴀɴᴀ ᴍᴡᴏʟ࿐' : process.env.BOT_NAME,
    ...
    SLINK: process.env.IG === undefined ? 'instagram.com/lino-ox' : process.env.IG,
    ...
    LOGOSK: process.env.ALL_IMG === undefined ? 'https://i.imgur.com/ucS4OCE.jpg' : process.env.ALL_IMG,
    created_by_souravkl11: process.env.ALL_IMG2 === undefined ? 'https://i.imgur.com/ucS4OCE.jpg' : process.env.ALL_IMG2,
    take_key: process.env.TAKE_KEY === undefined ? '' : process.env.TAKE_KEY,
    find_key: process.env.FIND_KEY === undefined ? '' : process.env.FIND_KEY,
    SKDL: process.env.DIALOGUE === undefined ? '❤ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝sᴀɴᴀ ᴍᴡᴏʟ࿐️‍❤️' : process.env.DIALOGUE,
    BLOCKMSG: process.env.BLOCK_MESSAGE === undefined ? 'default' : process.env.BLOCK_MESSAGE,
    UNBLOCKMSG: process.env.UNBLOCK_MESSAGE === undefined ? 'default' : process.env.UNBLOCK_MESSAGE,
    SOURAV: process.env.SK_BLOCK === undefined ? 'false' : process.env.SK_BLOCK,
    SOURAVKL11: process.env.STICKER_DATA === undefined ? 'ᴀғx-ᴀʙᴜ|ꪶ͢ɪͥᴛͭsᷤ ͢ᴍͫᴇͤᡃ⃝sᴀɴᴀ ᴍᴡᴏʟ࿐' : process.env.STICKER_DATA,
    ANTI_FAKE: process.env.AUTO_FAKE === undefined ? 'Abu' : process.env.AUTO_FAKE,
    ...
    sourav_g_link: process.env.GROUP_LINK === undefined ? 'https://chat.whatsapp.com/CooPMGJIC5gJ8LRVnp8HWu' : process.env.GROUP_LINK,
    BRANCH: 'master',
    HEROKU: {
